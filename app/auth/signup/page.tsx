    ...
    return (
      <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center px-5">
        <div className="w-full max-w-[380px] text-center">
          ...
          <Link href="/" className="text-sm text-[#7C3AED] hover:underline">Back to home</Link>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center px-5">
      <div className="w-full max-w-[380px]">
        ...
        <div className="bg-[#111111] border border-[#1F1F1F] rounded-2xl p-8">
          ...
          <p className="text-sm text-[#A1A1AA] mb-6">Free forever. No credit card needed.</p>
        ...
        <p className="text-center text-sm text-[#A1A1AA] mt-6">
          ...
          <Link href="/auth/login" className="text-[#7C3AED] hover:underline font-medium">
            Sign in
          </Link>
        </p>
      </div>
